...
public class Biblioteca implements IBiblioteca {
    ...
    public void memberFinder(int codigoPostal) {
        for (Socio member: socios) {
            if (member.getCodigoPostal() == codigoPostal) {
                member.infoMember();
            }
        }
    }
    ...
    public String toString() {
        return "Biblioteca{" +
                "nombre='" + nombre + '\'' +
                ", catalogo=" + Arrays.toString(libros) +
