package programacion.iesfm.empresa;
...
public class Empleado {
    ...
    public void info() {
        System.out.println("El nombre de este empleado es: " + nombre + " , sus apellidos son: " + apellidos + " , su nif es: " + nif + " y su puesto es: " + puesto);
    }
